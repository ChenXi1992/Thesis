...
def embed(batch, params, se_params, position_enc=None, to_reverse=0):
    ...
    out,lengths = embedding.getGloveEmb(batch,True,-1,params.word_emb_file)
   # out,lengths = embedding.getGensenEmb(batch,True,-1)
  #  out,lengths = embedding.getGloveEmb(batch,True,-1,)
   # out,lengths = embedding.getBertEmb(batch,True,-1)
