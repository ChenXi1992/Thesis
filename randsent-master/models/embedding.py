...
from models.gensen.gensen import GenSen, GenSenSingle
...
def getGensenEmb(batch,needPad = False,padLength = 30):
	...
	if gensen_1 == None:
		gensen_1 = GenSenSingle(model_folder='models/gensen/data/models',filename_prefix='nli_large_bothskip',pretrained_emb='models/gensen/data/embedding/glove.840B.300d.h5')
		gensen_2 = GenSenSingle(model_folder = 'models/gensen/data/models',filename_prefix ='nli_large',pretrained_emb='./data/embedding/glove.840B.300d.h5')
